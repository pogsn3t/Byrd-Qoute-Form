...
<div class="container steps" id="step1" style="display:block !important"> 
	...
	<div class="row mb-3">
		...
		<div class="col-12 invalidAddressInfo">
		  	 <span class="badge badge-danger">Address is invalid</span> 
		</div> 
	</div>

	<div class="row mb-3 suggested_address">
	  	<div class="col-8 ">
		  <span class="badge badge-primary">Suggested Address</span><br/>
 		  <span class="valid_add">2510 Eagle Run Benton, AR 72015</span><br/>
		   <a  class="btn btn-secondary" id="suggested_address_btn">Use this instead</a> 	  
		</div>
	...
	<div class="row mb-3">
		<div class="col">
		  <input type="button"  class="btn btn-primary" id="locsearch" value="Next" /> 
		</div>
	</div>
</div>
...
<div class="container steps" id="step2">
	...
	<div class="row mb-3">
		<div class="col">
			<input type="button"  id="prev1" class="btn btn-secondary" value="Previous" /> <input type="button"  class="btn btn-primary" id="next" value="Next" /> 
		</div>
	</div>
...
<div class="container steps" id="step3">
	...
	<div class="row mb-3">
		<div class="col"> 
			<input type="button"  id="prev2" class="btn btn-secondary" value="Previous" /> <input type="button"  id="submit" class="btn btn-primary" value="Submit" /> 
		</div>
	</div> 
...
<style>
	.steps, .hide, .invalidAddressInfo, .suggested_address{
		display:none;
	}
	input.error{
